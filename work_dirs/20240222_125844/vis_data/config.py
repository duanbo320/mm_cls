...
default_hooks = dict(
    ...
    visualization=dict(
        ...
        interval=1,
        out_dir=
        '/media/duanbo/hd_2/mmlab/mmpretrain/work_dirs/densenet201_4xb256_in1k/npc_val_adam/show_dir',
        show=False,
...
launcher = 'none'
load_from = '/media/duanbo/hd_2/mmlab/mmpretrain/work_dirs/densenet201_4xb256_in1k/epoch_75.pth'
log_level = 'INFO'
model = dict(
...
work_dir = '/media/duanbo/hd_2/mmlab/mmpretrain/work_dirs/densenet201_4xb256_in1k/npc_val_adam/'
